        ...
        <Box border="1" fontWeight="700" bgColor="#E5E5EA" color="#444444" align="center">
            <Flex p={{base:"8", xl:"50px 0"}} maxW="1272px" align="center" direction={{base: "column", md: "row"}} >
                ...
                <Flex align="center">
                    ...
                    <Button colorScheme="orange" bgColor="#F68D1F" size="lg" variant="solid" borderRadius="full">Sign Up</Button>
                </Flex>
            </Flex>
            <Box p="8" bgColor="#f5f5f5" color="#444" align="center"  >
            ...
            <Box p="3" bgColor="#F68D1F" color="white" align="center"  >
